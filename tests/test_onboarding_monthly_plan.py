...
class MonthlyPlanStepTests(unittest.TestCase):
    ...
    def test_example_and_initial_view_do_not_write(self):
        ...
        self.assertNotIn(t('ui.see_my_financial_picture'), self.ui.buttons)

    def test_create_income_reuses_current_pinned_month(self):
        self.ui.submit_label = t('ui.save_expected_income')
        self.render()
        self.create.assert_called_once_with(7, 2026, 9, 2500.0)
        self.ui.submit_label = None
        self.render()
        self.create.assert_called_once()
        self.assertEqual(self.ui.metrics[t('plan.expected_income')], "€2,500.00")
    ...
    def test_existing_plan_is_only_updated_by_explicit_income_save(self):
        ...
        self.ui.income, self.ui.submit_label = 3000.0, t('ui.save_expected_income')
        self.render()
    ...
    def test_allocations_pass_exact_categories_links_and_owner(self):
        ...
        for category in plan_ui.ALLOCATION_TYPES:
            with self.subTest(category=category):
                ...
                self.ui.submit_label = t('ui.add_allocation_detail')
                self.render()
        ...
        self.assertEqual(self.ui.options[t('ui.which_investment')], [20])
        self.assertEqual(self.ui.session_state["onboarding_7_step"], "monthly_plan")

    def test_missing_or_wrong_targets_do_not_write(self):
        self.create_plan()
        self.ui.category, self.ui.submit_label = "INVESTMENT", t('ui.add_allocation_detail')
        ...
        self.assets.clear()
        self.render()
        self.assertIn(t('ui.back_to_assets'), self.ui.buttons)
        self.ui.category = "FUND"
        self.funds.clear()
        self.render()
        self.assertIn(t('ui.back_to_funds'), self.ui.buttons)
        self.add.assert_not_called()

    def test_invalid_allocation_drafts_do_not_write(self):
        self.create_plan()
        self.ui.submit_label = t('ui.add_allocation_detail')
        for name, amount in [("  ", 10.0), (t('ui.living_costs'), None), (t('ui.living_costs'), -1.0)]:
    ...
    def test_totals_overallocation_and_income_update(self):
        self.create_plan()
        self.add_item(7, 70, t('ui.living_costs'), "EXPENSE", 1400)
        self.add_item(7, 70, "Saving", "FUND", 300, fund_id=10)
        self.add_item(7, 70, t('ui.investing'), "INVESTMENT", 400, asset_id=20)
        self.add_item(7, 70, "Travel", "FUND", 200, fund_id=10)
        self.render()
        self.assertEqual(self.ui.metrics[t('ui.planned_allocations')], "€2,300.00")
        self.assertEqual(self.ui.metrics[t('ui.unallocated')], "€200.00")
    ...
    def test_fresh_draft_and_finish_go_to_reveal_not_dashboard(self):
        ...
        self.ui.submit_label, self.ui.click = None, t('ui.add_another_allocation')
        self.render()
        self.assertTrue(self.ui.session_state[self.prefix + "allocation_open"])
        self.ui.click = t('ui.cancel')
        self.render()
        self.ui.click = t('ui.see_my_financial_picture')
        self.render()
    ...
    def test_income_only_plan_can_finish_without_creating_allocations(self):
        ...
        self.ui.click = t('ui.plan_allocations_later')
        self.render()
        self.ui.click = t('ui.see_my_financial_picture')
        self.render()
        self.assertEqual(self.ui.session_state["onboarding_7_step"], "financial_picture")
    ...
    def test_write_failure_offers_reload_on_next_rerun(self):
        ...
        self.ui.submit_label = None
        self.render()
        self.assertIn(t('ui.reload_allocations'), self.ui.buttons)
        self.assertNotIn("private detail", str(self.ui.errors))
